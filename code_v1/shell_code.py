...
def totalAEP(turb_diam, turb_coords, power_curve, wind_inst_freq):
    ...
    print('farm power shape',farm_pwr.shape)
...
if __name__ == "__main__":
    ...
    turb_coords    =  getTurbLoc(r'../data/Shell_Hackathon_Dataset/turbine_loc_test.csv')
    
    # Load the power curve
    power_curve    =  loadPowerCurve('../data/Shell_Hackathon_Dataset/power_curve.csv')
    
    # Pass wind data csv file location to function binWindResourceData.
    # Retrieve probabilities of wind instance occurence.
    wind_inst_freq =  binWindResourceData(r'../data/Shell_Hackathon_Dataset/Wind_Data/wind_data_2007.csv')
